...
class TextTypeFragment(private val survey: Survey) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_text_type, container, false)
        val ques = view.findViewById<TextView>(R.id.question_text_type)
